...
public final class OpenCmsTestProperties {
    ...
    /**
     * Property / Environment name for "test.import.folders".
     */
    public static final String PROP_TEST_IMPORT_FOLDERS = "test.import.folders";
    /**
     * Property / Environment name for "test.import.modules.in.order".
     */
    public static final String PROP_TEST_IMPORT_MODULES_IN_ORDER = "test.import.modules.in.order";
    /**
     * Property / Environment name for "test.config.path".
     */
    public static final String PROP_TEST_CMSSHELL_SCRIPTS_PATH = "test.cmsshell.scripts.path";
    /**
    ...
    /**
     * The path to the import test folder.
     */
    private String m_testImportFolders;
    /**
     * The path to the config files
     */
    private String m_testConfigPath;
    /**
     * The path to the config files
     */
    private String m_testCmsShellScriptsPath;
    /**
     * The path to the import test folder.
     */
    private String m_testImportModulesInOrder;
    /**
    ...
    public static void initialize(String basePath) {
        ...
        try {
            ...
            if (System.getProperty(PROP_TEST_IMPORT_FOLDERS) != null) {
                m_configuration.put(PROP_TEST_IMPORT_FOLDERS, System.getProperty(PROP_TEST_IMPORT_FOLDERS));
            } else if (allowGetEnv && (System.getenv(PROP_TEST_IMPORT_FOLDERS) != null)) {
                m_configuration.put(PROP_TEST_IMPORT_FOLDERS, System.getenv(PROP_TEST_IMPORT_FOLDERS));
            }
            if (System.getProperty(PROP_TEST_IMPORT_MODULES_IN_ORDER) != null) {
                m_configuration.put(PROP_TEST_IMPORT_MODULES_IN_ORDER, System.getProperty(PROP_TEST_IMPORT_MODULES_IN_ORDER));
            } else if (allowGetEnv && (System.getenv(PROP_TEST_IMPORT_MODULES_IN_ORDER) != null)) {
                m_configuration.put(PROP_TEST_IMPORT_MODULES_IN_ORDER, System.getenv(PROP_TEST_IMPORT_MODULES_IN_ORDER));
            }
            if (System.getProperty(PROP_TEST_CMSSHELL_SCRIPTS_PATH) != null) {
                m_configuration.put(PROP_TEST_CMSSHELL_SCRIPTS_PATH, System.getProperty(PROP_TEST_CMSSHELL_SCRIPTS_PATH));
            } else if (allowGetEnv && (System.getenv(PROP_TEST_CMSSHELL_SCRIPTS_PATH) != null)) {
                m_configuration.put(PROP_TEST_CMSSHELL_SCRIPTS_PATH, System.getenv(PROP_TEST_CMSSHELL_SCRIPTS_PATH));
            }
        ...
        m_testSingleton.m_testImportFolders = System.getProperty(PROP_TEST_IMPORT_FOLDERS);
        if (CmsStringUtil.isEmptyOrWhitespaceOnly(m_testSingleton.m_testImportFolders)) {
            m_testSingleton.m_testImportFolders = m_configuration.get(PROP_TEST_IMPORT_FOLDERS);
        }
        m_testSingleton.m_testImportModulesInOrder = System.getProperty(PROP_TEST_IMPORT_MODULES_IN_ORDER);
        if (CmsStringUtil.isEmptyOrWhitespaceOnly(m_testSingleton.m_testImportModulesInOrder)) {
            m_testSingleton.m_testImportModulesInOrder = m_configuration.get(PROP_TEST_IMPORT_MODULES_IN_ORDER);
        }
        m_testSingleton.m_testCmsShellScriptsPath = System.getProperty(PROP_TEST_CMSSHELL_SCRIPTS_PATH);
        if (CmsStringUtil.isEmptyOrWhitespaceOnly(m_testSingleton.m_testCmsShellScriptsPath)) {
            m_testSingleton.m_testCmsShellScriptsPath = m_configuration.get(PROP_TEST_CMSSHELL_SCRIPTS_PATH);
        }
    ...
    /**
     * 
     * @return the datapath for temporary generated and modified files during
     * test runs
     */
    public String getTestDataPathTmp() {
        return m_testDataPath + "tmp";
    }

    /**
     * @return the import folder separated by a delimiter
     */
    public String getTestImportFolders() {

        return m_testImportFolders;
    }

    /**
     * @return the import modules separated by a delimiter
     */
    public String getTestImportModulesInOrder() {

        return m_testImportModulesInOrder;
    }

    /**
     * @return the config path
     */
    public String getTestCmsShellScriptsPath() {

        return m_testCmsShellScriptsPath;
    }
